...
export default function Support() {
    const { sendMessage, messages, changeRoom, newUsers, supportOnline, isTyping, stopTyping, userTyping, auth } = useContext(SocketContext);
                ...
                <section id="support-chat" className="flex flex-row">
                    ...
                    <div id="chat">
                        ...
                        <form id="message-form" onSubmit={Submitter} className='flex flex-row gap-1'>
                            ...
                            <input id="message-chat-box" ref={messageRef} type="text" placeholder="Message" onChange={doTyping} maxlength="255" required />
